...
import * as mockedCreateStoreStateImport from '../../createStoreState';
import type {
...
import type { SettersCounterFactory } from '../../__mocks__/createStoreState';
import { executionCountersFactory } from './executionCounter';
import type { TestDescriptionG, TestParameterG } from './testDescriptionTypes';
import { wrapWithStrictModeComponent } from './wrapWithStrictModeComponent';

jest.mock('../../createStoreState.ts');
