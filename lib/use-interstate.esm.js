...
var createStore = function createStore(initStateValues) {
  ...
  function initState(initV) {
    initV &&
      getEntriesOfEnumerableKeys(initV).forEach(function (_ref3) {
  ...
  function proceedReactCleaningWatchList() {
    traverseLinkedList(reactCleaningWatchList, function (_ref5) {
      var removeTriggerFromKeyList = _ref5.removeTriggerFromKeyList;
